...
import { faCartArrowDown, faList, faCommentDots } from '@fortawesome/free-solid-svg-icons';
import './Customer.css'
    ...
    return (
        ...
        <div className="row " style={{margin:'0 auto'}}>
            <div className="col-md-2">
                <ul>
                    <Link onClick={order}><><FontAwesomeIcon icon={faCartArrowDown}></FontAwesomeIcon>  Order</></Link>
